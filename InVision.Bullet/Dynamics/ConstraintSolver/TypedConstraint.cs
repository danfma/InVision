	...
	///use getAppliedImpulse, getAppliedLinearImpulse and getAppliedAngularImpulse to read feedback information
        ...
        public float AdjustAngleToLimits(float angleInRadians, float angleLowerLimitInRadians, float angleUpperLimitInRadians)
        {
	        ...
	        else if(angleInRadians < angleLowerLimitInRadians)
	        {
                ...
                float diffHi = System.Math.Abs(MathUtil.NormalizeAngle(angleUpperLimitInRadians - angleInRadians));
	        ...
	        else if(angleInRadians > angleUpperLimitInRadians)
	        {
		        ...
		        float diffLo = System.Math.Abs(MathUtil.NormalizeAngle(angleInRadians - angleLowerLimitInRadians));
