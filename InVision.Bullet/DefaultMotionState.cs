...
namespace InVision.Bullet
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="DefaultMotionState"/> class.
		/// </summary>
		...
		/// Initializes a new instance of the <see cref="DefaultMotionState"/> class.
		/// </summary>
		/// <param name="startTrans">The start trans.</param>
		/// <param name="centerOfMassOffset">The center of mass offset.</param>
