...
namespace InVision.Bullet.Collision.CollisionShapes
{
    public class UniformScalingShape : ConvexShape
    {
        ...
        public override Vector3 CalculateLocalInertia(float mass)
        {
	        ...
	        Vector3 tmpInertia = m_childConvexShape.CalculateLocalInertia(mass);
	        
			return tmpInertia * m_uniformScalingFactor;
        }
    	...
    	public override float Margin
    	{
    		...
    		get { return m_childConvexShape.Margin * m_uniformScalingFactor; }
    	}
