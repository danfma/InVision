...
namespace InVision.Ogre3D
{
	...
	public class Node : Handle
	{
		...
		public Node Parent
		{
			get { return NativeNode.GetParentNode(handle); }
		}
		...
		public Vector3 Position
		{
			...
			set { NativeNode.SetPosition(handle, value); }
		}
		...
		{
			set { NativeNode.SetInheritOrientation(handle, value); }
			get { return NativeNode.GetInheritOrientation(handle); }
		}
		...
		{
			get { return NativeNode.GetInheritScale(handle); }
			set { NativeNode.SetInheritScale(handle, value); }
		}
		...
		{
			NativeNode.Translate(handle, direction, relativeTo);
		}
		...
		{
			NativeNode.Translate(handle, x, y, z, relativeTo);
		}
	}
}