...
{
	internal sealed class NativeOgreConfigFile : PlatformInvoke
	{
			...
			IntPtr pConfigFile)
		{
			...
			foreach (var sectionPair in sectionEnumeration)
			{
				...
				{
					NativeOgreUtilities.DeleteNameHandlePair(pNameHandlePair);
				}
			}
		}
		...
		public static string[] MultiSetting(IntPtr pConfigFile, string key, string section)
		{
			...
			{
				NativeOgreUtilities.DeleteStringArray(result);
			}
		}
