...
namespace InVision.Ogre.Native
{
	...
	internal sealed unsafe class NativeOverlayElement : InVision.Native.PlatformInvoke
	{
		...
		public static extern char* GetCaption(Handle self);
		...
		[DllImport(Library, EntryPoint = "overlayelement_delete_wide_string")]
		public static extern void DeleteWideString(char* pdata);
	}
